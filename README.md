...
Follow the instructions in `starter_code/main_project.ipynb` and be sure to set up your Anaconda environment to ge
...
```
https://github.com/garg-sparsh/Patient-Selection_for_Diabetes_Drug_Testing.git
```

2. Create (and activate) a new environment, named `diabetes_drug_testing` with Python 3.7. If prompted to proceed with the install `(Proceed [y]/n)` type y.
